      ...
      <div className="form-container font-number text-black dark:text-white mb-3">
        <div className="mb-3 w-full">
          ...
          <input
            ...
            required
            {...register(name)}
            className="w-full font-raleway rounded-md py-2.5 px-5 font-light text-neutral-600 text-base focus:text-black focus:border-black dark:text-neutral-500 dark:focus:text-neutral-300 bg-transparent border hover:border-neutral-700 dark:border-neutral-800 dark:hover:border-neutral-700 focus:outline-none dark:focus:border-neutral-700 placeholder-neutral-400"
          />
