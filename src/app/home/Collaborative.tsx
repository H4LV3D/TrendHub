  ...
  return (
    <>
      <div className="relative py-20 bg-[#F7F7F7] dark:bg-neutral-800/75 w-full overflow-hidden flex flex-col items-center justify-center dark:border-neutral-700 ">
        <div className="container flex flex-col justify-center sm:items-center lg:w-[900px] dark:text-neutral-400">
          <p className="text-base sm:text-xl md:text-2xl mb-1 sm:mb-4">
            Introducing
          </p>
